---
title: 'Modeling: support vector machine (outcome: log 90d downloads)'
author: 
- "Perry Kuo"
...
```{r  model_svm_radial_grid1_plot, fig.width= 12, fig.height=8, eval = FALSE}
...
```{r  model_svm_radial_grid2_plot, fig.width= 12, fig.height=8, eval = FALSE}
...
```{r  model_svm_radial_grid3_plot, fig.width= 12, fig.height=8, eval = FALSE}
...
```{r  model_svm_radial_grid4_plot, fig.width= 12, fig.height=8, eval = FALSE}
...
```{r model_svm_download_cnt_90d_LOG-2, fig.width= 6, fig.height=5}
...
ggplot(plt.df, aes(x = obs, y = pred)) + 
  ...
  labs(title = paste0("Predictions for y = log(# of downloads in 90 days)"),
